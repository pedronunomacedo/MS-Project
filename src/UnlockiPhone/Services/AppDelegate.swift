...
//                WatchAccelerometer.shared.updateCoordinates(receivedCoordinate: (x: coordinates["x"] as? Double ?? 0.0, y: coordinates["y"] as? Double ?? 0.0, z: coordinates["z"] as? Double ?? 0.0, timestamp: coordinates["timestamp"] as! Date ))
//                
